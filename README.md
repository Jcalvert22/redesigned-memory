...
|-----------|------------|---|---------|
| Authenticaiton System | Added supabase capability for authentication. Using the ANON key and Website key when users sign up, it pings the website and private key to store the information and give user status back to the client. | https://github.com/Jcalvert22/redesigned-memory/issues/5  | 
